...
function renderLeaderboard() {
	...
	for (let i = 0; i < min(game.board.show, game.board.list.length); i++) { // Body
		// Cell Boxes
		...
		text(game.board.list[i].name, game.board.x + game.board.text.marginLeft, game.board.y + (i + 1) * game.board.rowHeight + game.board.text.marginTop); // Screen name renders under kills box
...
function keyPressed() {
	...
	if (keyCode == RESPAWNKEY) { // R by default
