class Game {
   ...
   constructor(data) {
      Game.game = null; // Initialize static fields
   ...
   createGame(data) {
      ...
      Socket.socket.emit('Game Created', Game.game);
      if (Game.game.info.protected) // If game is password protected
         Socket.socket.emit('Password Created', { pass: data.password, info: Game.game.info });
   }
};
